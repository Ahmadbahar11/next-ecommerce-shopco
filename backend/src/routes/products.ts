...
const productInput = z.object({
  ...
  conditionNotes: z.string().max(2000).nullable().optional().default(null),
  defectNotes: z.string().max(2000).nullable().optional().default(null),
  authenticityVerified: z.boolean().default(false),
  includesOriginalBox: z.boolean().default(false),
  insoleLengthMm: z.number().int().positive().max(500).nullable().optional().default(null),
